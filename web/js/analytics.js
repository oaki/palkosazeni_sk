(function() {
    ...
    var p = /^(GTM|OPT)-[A-Z0-9]+$/, q = /;_gaexp=[^;]*/g, r = /;((__utma=)|([^;=]+=GAX?\d+\.))[^;]*/g, Aa = /^https?:\/\/[\w\-.]+\.google.com(:\d+)?\/optimize\/opt-launch\.html\?.*$/, t = function(a) {
        function b(a, b) {
            b && (c += "&" + a + "=" + K(b))
        }
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/, pc = function(a) {
        ...
        a:if (c = a.get(cc), d = E(M.location[c ? "href" : "search"], "_ga"))if (a.get(bc))if (c = d.indexOf("."), -1 == c) J(22); else {
            var e = d.substring(0, c), g = d.substring(c + 1), c = g.indexOf("."), d = g.substring(0, c), g = g.substring(c + 1);
            if ("1" == e) {
